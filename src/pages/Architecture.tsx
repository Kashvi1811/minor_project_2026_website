...
const Architecture = () => (
  <DocsLayout>
    <PageHeader step={1} title="VM Architecture" description="Understanding the core components of the 16-bit virtual machine." />
...
[16] [16] [16] [16] [16] [16] [16] [16]  bits each`}</CodeBlock>
    ...
    <div className="grid md:grid-cols-2 gap-4 mt-4">
      <SectionCard title="Program Counter (PC)">
      ...
      <SectionCard title="Condition Flags">
    ...
    <SectionCard title="Memory" className="mt-4">
    ...
    <SectionCard title="Execution Cycle" className="mt-4">
      <p className="text-sm text-muted-foreground mb-3">The VM follows a classic fetch-decode-execute loop:</p>
      <ol className="text-sm text-muted-foreground space-y-2 list-decimal list-inside">
        <li><strong>Fetch</strong> — Read instruction at memory[PC], increment PC</li>
        <li><strong>Decode</strong> — Extract opcode (bits 15–12), register fields, and immediate</li>
        <li><strong>Execute</strong> — Perform the operation, update flags if needed</li>
        <li><strong>Log</strong> — Record step to trace file</li>
        <li><strong>Repeat</strong> until HALT (opcode 0)</li>
      </ol>
    </SectionCard>
  </DocsLayout>
);
